...
public enum SoundType
{
    ...
    ButtonLock,     // Sound for locked button interactions.
    ButtonQuit,     // Sound for quitting the game.
    BackgroundMusic,// Background music playing during the game.
    ItemPickup,     // Sound when an item is picked up.
    PlayerMove,     // Sound for player movement.
    PlayerDeath,    // Sound for player death.
    PlayerHurt,     // Sound when player gets hurt.
    PlayerJump,     // Sound when player jumps.
    ChomperMove,    // Sound for chomper movement.
    LevelSuccess,   // Sound for level completion.
    LevelFail,      // Sound for level failure.
